...
class PlatformDispatcher {
  ...
  void _updateUserSettingsData(String jsonData) {
    ...
    if (textScaleFactorChanged) {
      ...
      _systemTextScaler = _SystemTextScaler(this, textScaleFactor);
  ...
  late _SystemTextScaler _systemTextScaler = _SystemTextScaler(this, textScaleFactor);
...
///
/// This class should typically be immutable. Its [==] operator defines the
/// equality of 2 [TextScaler]s, which the framework uses to determine whether
/// text widgets should rebuild when their [TextScaler] changes. Consider
/// overriding the [==] operator if applicable to avoid unnecessary rebuilds.
...
final class _ClampedTextScaler implements TextScaler {
  ...
  TextScaler clamp({ double minScaleFactor = 0, double maxScaleFactor = double.infinity }) {
    return minScaleFactor == maxScaleFactor
      ...
      : _ClampedTextScaler(scaler, math.max(minScaleFactor, minScale), math.min(maxScaleFactor, maxScale));
  }
...
class _SystemTextScaler extends TextScaler {
  _SystemTextScaler(this.platformDispatcher, this.textScaleFactor);
